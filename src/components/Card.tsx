const Card = () => {
  return (
    <div className="flex flex-col bg-white p-3 w-full gap-3 shadow-lg rounded-md">
      <div className="flex gap-1">
        <div className="p-2 rounded-2xl bg-pink-600 w-15"></div>
        <div className="p-2 rounded-2xl bg-cyan-400 w-15"></div>
      </div>
      <div className="p-2 rounded bg-gray-300 w-auto max-w-xs md:max-w-lg"></div>
      <div className="flex justify-between gap-5 md:gap-25">
        <div className="flex gap-1">
